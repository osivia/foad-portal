parallel portalbranch: {
	...
	node {
		...
		stage("collab-tools") {
		    ...
		    sh "'${mvnHome}/bin/mvn' clean install -f collab-tools"
		}		
		stage("checkin") {
		...
		stage("wf-integration") {
		    ...
		    sh "'${mvnHome}/bin/mvn' clean install -f wf-integration"
		}
		stage("ottc-news") {
		    ...
		    sh "'${mvnHome}/bin/mvn' clean install -f ottc-news"
		}		
		stage("drive") {
			...
			sh "'${mvnHome}/bin/mvn' clean install -f drive"
		}
		stage("nx-distrib") {
