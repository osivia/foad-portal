...
<c:set var="academie" value="${document.properties['foad:academie']}" />
                ...
                <!-- Académie -->
                <c:if test="${not empty academie}">
                    <dt><op:translate key="DOCUMENT_METADATA_ACADEMIE" /></dt>
                    <dd>
                        <p>
                            <ttc:vocabularyLabel name="Academie" key="${academie}"/>
                        </p>
                    </dd>
                </c:if>                